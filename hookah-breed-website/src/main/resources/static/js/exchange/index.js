...
$(function () {
    ...
    //     var screeW='';
    //     var cab='';
    //     // if( screen.width() >=1100 && screen.width()<=1440) {
    //     //     screeW=screen.width();
    //     //     liWidth=screeW/4;
    //     //     $(".screen ul li").css({
    //     //         'width':liWidth
    ...
    //     //         }else if(i>0 && k==0){
    //     //             ul.css({
    //     //                 'left':parseInt(ul.css('left'))+cab*pic+(cab/4)*lisLg
    //     //             });
    //     //         }else if(k>0){
    //     //             ul.css({
    //     //                 'left':parseInt(ul.css('left'))+cab*pic+cab*k+(cab/4)*lisLg
    //     //             });
    //     //         }
    //     //     }
    //     // };
