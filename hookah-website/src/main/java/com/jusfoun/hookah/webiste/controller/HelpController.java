...
//                    dataMap.put("respSample", goodsVo.getApiInfo().getRespSample() == null ? goodsVo.getApiInfo().getRespSample() : goodsVo.getApiInfo().getRespSample().replace("&", "&amp;"));
                    ...
                    returnData.setData("http://open.lsdashuju.net/down/doc?apiId=" + sourceId + "&orderNo=" + orderNo);
//                    returnData.setData("http://open.lsdashuju.net/down/doc?apiId=2&orderNo=1");
                    return returnData;
