...
public class FormatCheckUtil {
    ...
    public static boolean checkMobile(String mobile){
        String regExp = "^1(3[0-9]|4[5-9]|5[0-35-9]|66|7[0-9]|8[0-9]|9[8-9])\\d{8}$";
    ...
    /*public static boolean checkMobileAndPhone(String input,Integer...type){
        *//**
         ...
         * 电信：133,134,153,170,177,180,181,189
         *//*
        String mobile = "^1(3[0-9]|4[5-9]|5[0-35-9]|66|7[0-9]|8[0-9]|9[8-9])\\d{8}$";  //所有手机
        *//**
         * 中国移动：China Mobile
        ...
        *//**
        ...
        //手机+固话
        String all = "^(1(3[0-9]|4[5-9]|5[0-35-9]|66|7[0-9]|8[0-9]|9[8-9])\\d{8})|((0[0-9]{2,3}\\-?)?([2-9][0-9]{6,7})+(\\-?[0-9]{1,4})?)$";
