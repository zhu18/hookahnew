...
public class GoodsShelves extends GenericModel {
     ...
     * @mbggenerated
     */
    public String getShelvesTypeId() {
     ...
     *
     * @param shelvesTypeId the value for goods_shelves.shelves_type_id
     *
     * @mbggenerated
     */
    public void setShelvesTypeId(String shelvesTypeId) {
        this.shelvesTypeId = shelvesTypeId == null ? null : shelvesTypeId.trim();
    }
