...
public class Organization extends GenericModel {
    ...
    public Byte getLawPersonCategory() {return lawPersonCategory;}

    public void setLawPersonCategory(Byte lawPersonCategory) {
        this.lawPersonCategory = lawPersonCategory;
    }

    public String getLawPersonNum() {return lawPersonNum;}

    public void setLawPersonNum(String lawPersonNum) {this.lawPersonNum = lawPersonNum;}

    public String getLawPersonPositivePath() {return lawPersonPositivePath;}

    public void setLawPersonPositivePath(String lawPersonPositivePath) {
        this.lawPersonPositivePath = lawPersonPositivePath;
    }

    public String getLawPersonNegativePath() {return lawPersonNegativePath; }
