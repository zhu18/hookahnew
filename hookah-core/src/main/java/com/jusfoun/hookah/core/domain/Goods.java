...
public class Goods extends GenericModel {
    ...
    /**
     * This field was generated by MyBatis Generator.
     * This field corresponds to the database column goods.is_book
     *
     * @mbggenerated
     */
    private Byte isBook;
    ...
    /**
     * Add by guoruibing on 2017-07-03.
     */
    private String ver; // 版本号

    private String trialRange; //适用范围

    private String goodsAdvantage; //商品优势

    private String afterSaleService; //售后服务

    private String dataSample; //数据样例

    private String appCase; //应用案例

    private Byte isDiscussPrice; //价格可议
    ...
    private Byte purchaseLimit; // 购买限制
    ...
    public String getTrialRange() {
        return trialRange;
    }

    public void setTrialRange(String trialRange) {
        this.trialRange = trialRange;
    }
