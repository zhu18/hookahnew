 ...
 * @created 2016年7月18日
 */
public class MgGoodsOrder extends OrderInfo {
	...
	@Transient
	private MgOrderGoods mgOrderGoods;//订单里的单个商品
	@Transient
	...
	public MgOrderGoods getMgOrderGoods() {
		return mgOrderGoods;
	}

	public void setMgOrderGoods(MgOrderGoods mgOrderGoods) {
		this.mgOrderGoods = mgOrderGoods;
	}
