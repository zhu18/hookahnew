package com.jusfoun.hookah.console.webapi;
...
public class WebAPILauncher {
    private static final Logger logger = LoggerFactory.getLogger(WebAPILauncher.class);
