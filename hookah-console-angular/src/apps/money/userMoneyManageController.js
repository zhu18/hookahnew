class userMoneyManageController {
  constructor($scope, $rootScope, $http, $state, $uibModal, usSpinnerService, growl) {
    ...
    $scope.setCardCode = function (setCardCode) {
      console.log(setCardCode);
      if (setCardCode !== null) {
        return setCardCode.slice(setCardCode.length - 4);
      }
    };
    $scope.showUserMoneyDetail = function (item) {
      $state.go('money.showUserMoneyDetail', {item: item});
    };
...
export default userMoneyManageController;