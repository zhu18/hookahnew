...
public class LogUtil {
	private final static Logger GATELOG = LoggerFactory.getLogger(LogUtil.class);
//	private final static Logger aa = LoggerFactory.getLogger("ACP_SDK_LOG");
...
//	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger("SDK_MSG_LOG");
	...
	private final static Logger GATELOG_ERROR = LoggerFactory.getLogger(LogUtil.class);
	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger(LogUtil.class);
