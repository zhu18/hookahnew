...
public class DictionaryUtil {
    ...
    public void init() {
        ...
        dictionaryUtil.goodsLabelService = this.goodsLabelService;
    }
    ...
    public static GoodsLabel getGoodsLabelById(String id) {
        return dictionaryUtil.goodsLabelService.selectById(id);
    }
}
